...
var snapHorizSize = 22;
var snapVertSize = 22;
var horizDockWidth = 36;	// When docked to the left or right
var vertDockHeight = 36;
var toolbarPos = "left";	// Start at this position
...
document.styleSheets[0].addRule("#handle1", "border-left: 1 solid buttonhighlight; border-right: 1 solid buttonshadow; border-top: 1 solid buttonhighlight; border-bottom: 1 solid buttonshadow;" +
								"padding: 0; margin: 1; cursor: move; width: 3; height: 18; overflow: hidden;");								
...
function fixSize() {
	...
	switch (toolbarPos) {
		...
		handle1.style.height = vertDockHeight - 2;
		handle1.style.width = 3;
		break;
		...
		handle1.style.height = 3;
		handle1.style.width = horizDockWidth -2;
		break;
		...
		handle.style.width = 3;
		handle1.style.height = floatHeight - 6;
		handle1.style.width = 3;
	}
